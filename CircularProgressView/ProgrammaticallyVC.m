#import "ProgrammaticallyVC.h"
#import "CircularProgressView.h"

@interface ProgrammaticallyVC ()
@property (nonatomic, strong) CircularProgressView *progressView;
@property (nonatomic, strong) UIButton *plusButton;
@property (nonatomic, strong) UIButton *minusButton;
@end

@implementation ProgrammaticallyVC
...
- (void)viewDidLoad {
    ...
    CGRect frame = CGRectMake(centerOfView.x - radius, centerOfView.y - radius, 2 * radius, 2 * radius);
    self.progressView = [[CircularProgressView alloc] initWithFrame:frame radius:radius lineWidth:10 outerStrokeColor:[UIColor whiteColor] innerStrokeColor:[UIColor grayColor]];
